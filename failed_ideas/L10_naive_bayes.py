...
def main():
    ...
    pd.concat(preds_test).to_csv('naive_bayes_test_{}.csv'.format(starttime), index=False)
    pd.concat(preds_vali).to_csv('naive_bayes_vali_{}.csv'.format(starttime), index=False)
    print("All done")
